...
export default function Home() {
  ...
  // Limite máximo de upload em bytes (4MB)
  ...
  const handleUpload = async (e) => {
    ...
    // Converte a imagem para Base64 (Data URI) para enviar à API
    ...
    reader.onload = async () => {
      ...
      try {
        ...
        if (response.status !== 200) {
          setError(data.message || "Erro desconhecido da API.");
        } else {
          // O Replicate retorna um array de URLs, pegamos o primeiro elemento
